    ...
    <footer class="footer">
        <div class="container">
            <div class="row align-items-center gy-3">
                <div class="col-md-6"><h5 class="fw-bold mb-1">HMS - Hospital Management System</h5><p class="mb-0 text-muted">Transformando a gestao hospitalar brasileira.</p></div>
                <div class="col-md-6 text-md-end"><a href="#" class="text-decoration-none me-3">Termos</a><a href="#" class="text-decoration-none me-3">Privacidade</a><a href="#" class="text-decoration-none">Contato</a></div>
            </div>
        </div>
    </footer>
<?php render_scripts(); ?>
