            ...
            <div class="container text-center">
                <div class="row justify-content-center mb-5">
                    <div class="col-lg-8">
                        ...
                        <p class="lead text-muted">O Hospital Management System (HMS) é uma plataforma integrada desenvolvida para otimizar todos os processos hospitalares, desde o cadastro de pacientes até a gestão de leitos e especialidades médicas.</p>
                    </div>
                </div>
