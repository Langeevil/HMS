...
<?php render_user_menu($usuarioLogado['nome'] ?? 'Usuario'); ?>
                ...
                <div class="row mt-3 g-3">
                    ...
                    <div class="col-lg-4"><div class="page-card h-100"><h5 class="fw-bold mb-4">Acesso rapido</h5><div class="d-grid gap-2"><a href="<?= h(url($basePath, 'pacientes/form.php')) ?>" class="btn btn-outline-primary text-start"><i class="bi bi-plus-circle me-2"></i>Cadastrar paciente</a><a href="<?= h(url($basePath, 'medicos/form.php')) ?>" class="btn btn-outline-primary text-start"><i class="bi bi-person-badge me-2"></i>Registrar medico</a><a href="<?= h(url($basePath, 'leitos/listar.php')) ?>" class="btn btn-outline-primary text-start"><i class="bi bi-hospital me-2"></i>Consultar leitos</a></div></div></div>
                </div>
            </main>
        </div>
    </div>
