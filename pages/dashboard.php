...
<?php render_admin_sidebar($basePath, 'dashboard'); ?>
            <main class="col-lg-9 col-xl-10 content-area content-shell">
                <header class="top-header">
                    <div>
                        <p class="h5 mb-1 fw-bold">Resumo do sistema</p>
...
<?php render_user_menu(current_user_name(), url($basePath, 'pages/logout.php')); ?>
                ...
                <section class="page-card mb-3">
                    <div class="row align-items-center g-3">
                        <div class="col-lg-8">
                            <span class="eyebrow eyebrow-admin text-dark border-0">Central de operações</span>
                        ...
                        <div class="col-lg-4">
                            <div class="metric-card">
                                <p class="text-muted mb-2">Visão operacional</p>
                                <h2 class="h3 fw-bold mb-1">Controle rápido dos setores</h2>
