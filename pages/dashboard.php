            ...
            <main class="col-lg-9 col-xl-10 content-area content-shell">
                <header class="top-header">
                    <div>
                        ...
                        <p class="mb-0 text-muted">Acompanhe os principais módulos administrativos e a rotina da unidade em um único painel.</p>
                    </div>
<?php render_user_menu(current_user_name(), url($basePath, 'pages/logout.php')); ?>
                ...
                <section class="page-card mb-3">
                    <div class="row align-items-center g-3">
                        <div class="col-lg-8">
                            <span class="eyebrow text-dark border-0" style="background: rgba(87, 183, 200, 0.12); color: var(--hms-primary);">Central de operações</span>
                            <h1 class="display-6 fw-bold mt-3 mb-2">Gestão integrada do ambiente hospitalar.</h1>
                            <p class="text-muted mb-0">Consulte equipes médicas, pacientes, leitos, alas, quartos e especialidades com acesso rápido aos principais fluxos administrativos.</p>
                        </div>
                        <div class="col-lg-4">
                            <div class="metric-card">
                                <p class="text-muted mb-2">Visao operacional</p>
                                <h3 class="fw-bold mb-1">Controle rápido dos setores</h3>
                                <p class="text-muted mb-0">Acesse os cadastros essenciais para manter a unidade organizada e acompanhar a ocupação hospitalar.</p>
                            </div>
                        </div>
                    </div>
                </section>
                <div class="row g-3">
                    <div class="col-md-6 col-xl-4"><a href="<?= h(url($basePath, 'pages/medicos/listar.php')) ?>" class="text-decoration-none"><div class="card stat-card h-100 text-center p-4 border-0"><div class="icon-shape bg-primary bg-opacity-10 text-primary mx-auto mb-3"><i class="bi bi-person-badge display-6"></i></div><h4 class="fw-bold text-dark mb-1">Médicos</h4><p class="text-muted small mb-0"><?= h(($totais['medicos'] ?? 0) . ' profissionais') ?></p><div class="mt-3 text-primary fw-bold small">Gerenciar <i class="bi bi-arrow-right"></i></div></div></a></div>
