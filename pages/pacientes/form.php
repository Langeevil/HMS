...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $erro = $response['error'] ?: 'Nao foi possivel salvar o paciente.';
}
...
<?php endif; ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6"><label for="codtipo" class="form-label">Tipo sanguineo</label><select name="codtipo" class="form-select" id="codtipo" required><option value="">Selecione...</option>
